...
102.  ### How do you group and nest console output?
      ...
      console.log("name: Avet Badalyan");
...
123. ### What are the possible ways to create objects in JavaScript
    ...
    4. **Function constructor:**
       ...
       var object = new Person("Avet Badalyan");
       ```
    5. **Function constructor with prototype:**
       ...
       ```javascript
       function Person() {}
      Person.prototype.name = "Avet Badalyan";
...
180. ### Mixin Example using Object composition
     ...
     // Use it
     const person = new Person("Avet Badalyan");
...
const p1 = new Person("Avet Badalyan");
console.log(p1.name); // Avet Badalyan
```
